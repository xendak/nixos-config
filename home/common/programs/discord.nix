  ...
  cfg_file = pkgs.writeText "settings.json" ''
        {
          ...
          "openasar": {
            "setup": true,
            "quickstart": true,
    "css": "@import url('https://refact0r.github.io/midnight-discord/midnight.css');:root {--spacing: 12px;--roundness: 16px;--font: 'Sofia Pro';--online-indicator: var(--text-2);--moon-icon: block; --discord-icon: none;--accent-1: #${palette.base0D};--accent-2: #${palette.base08};--accent-3: #${palette.base0B}60;--accent-4: #${palette.base02};--accent-5: #${palette.base00};--mention: #${palette.base01}80;--mention-hover: #${palette.base01}c0;--text-1: #${palette.base07};--text-2: #${palette.base0B};--text-3: #${palette.base05};--text-4: #${palette.base05};--text-5: #${palette.base03};--bg-1: #${palette.base02};--bg-2: #${palette.base0C}90;--bg-3:  #${palette.base01};--bg-4: #${palette.base00};--hover: #${palette.base0C}20;--active: #${palette.base0C}60;--message-hover: #${palette.base02}90;}"
          }
        }
  '';
in {
