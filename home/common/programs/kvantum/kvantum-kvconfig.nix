    ...
    "${config.xdg.configHome}/Kvantum/nixos/nixos.kvconfig" = {
      text = ''
        ...
        [GeneralColors]
          ...
          button.color=#IDK#
          light.color=#${colors.base04}
          mid.light.color=#IDK#
          dark.color=#IDK#
          mid.color=#IDK#
          highlight.color=#${colors.base0C}
          inactive.highlight.color=#${colors.base0B}
          text.color=#${colors.base05}
          window.text.color=#${colors.base05}
          button.text.color=#${colors.base05}
          disabled.text.color=#${colors.base04}
          tooltip.text.color=#${colors.base04}
          highlight.text.color=#${colors.base00}
          link.color=#${colors.base0A}
          link.visited.color=#${colors.base0A}
          progress.indicator.text.color=#${colors.base0C}
        ...
        [PanelButtonCommand]
          ...
          text.press.color=#${colors.base02}
          text.toggle.color=#${colors.base09}
          text.shadow=0
          text.margin=4
          text.iconspacing=4
